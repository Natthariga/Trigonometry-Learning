                                ...
                                setSheets(prev =>
                                    prev.map(s =>
                                        Number(s.sheet_id) === Number(updatedSheet.sheet_id)
                                            ? {
                                                ...s, // ข้อมูลเดิมทั้งหมด
                                                ...updatedSheet, // ข้อมูลที่แก้ไขมา
                                                student_id: s.student_id,       // ยืนยันให้เก็บ student_id เดิม
                                                student_name: s.student_name,   // ยืนยันให้เก็บชื่อคนเพิ่มเดิม
                                                view_count: s.view_count,       // เก็บ view_count เดิม
                                            }
                                            : s
                                    )
                                );
