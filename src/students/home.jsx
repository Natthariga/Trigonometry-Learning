        ...
        <section id='header' className="flex justify-center items-center py-20 bg-gray-100 w-full md:p-3 min-h-[400px]">
          <div className="container mx-auto flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-10">
            <div className="w-full md:w-1/2 text-center md:text-left">
              <h2 className="text-4xl md:text-5xl font-semibold text-black mb-4">เริ่มต้นใช้งานทันที</h2>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="col-md">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                <Link to="/ai-practice" className="w-50 p-6 bg-white rounded-xl shadow-md relative">
                  ...
                  <div className="flex flex-col text-start">
                    ...
                    <p className="text-md font-medium text-gray-700">โจทย์ตรีโกณมิติ</p>
                    <p className='text-sm my-1 text-gray-400'>ด้วยโจทย์ที่สร้างโดย AI เพื่อพัฒนาทักษะการคิดวิเคราะห์อย่างเป็นระบบ</p>
                  </div>
                </Link>

                <Link to="/triggraph" className="w-50 p-6 bg-white rounded-xl shadow-md relative">
                  ...
                  <div className="flex flex-col text-start">
                    ...
                    <p className="text-md font-medium text-gray-700">สร้างกราฟตรีโกณมิติ</p>
                ...
                <Link to="/wolframAlpha" className="w-50 p-6 bg-white rounded-xl shadow-md relative">
                  ...
                  <div className="flex flex-col text-start">
                    ...
                    <p className="text-md font-medium text-gray-700">ผู้ช่วยคำนวณสูตรขั้นสูง</p>
                    <p className='text-sm my-1 text-gray-400'>เครื่องมือคำนวณสูตรพื้นฐานของตรีโกณมิติพร้อมแสดงรูปภาพให้เห็นชัดเจน</p>
                  </div>
                </Link>

                <Link to="/score" className="w-50 p-6 bg-white rounded-xl shadow-md relative">
                  ...
                  <div className="flex flex-col text-start">
                    ...
                    <p className="text-md font-medium text-gray-700">อันดับคะแนน</p>
