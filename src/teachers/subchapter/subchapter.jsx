                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {/* <div className="flex gap-6 mr-3">
                                            ...
                                            <button
                                                ...
                                                className="flex items-center gap-1 p-2.5 py-1.5 rounded-lg bg-grey-5 text-blue-700 text-xs font-medium hover:bg-blue-700 hover:text-white transition duration-200 shadow-sm"
                                            >
                                                <FaPlus className="w-3 h-3" />
                                                <span>เพิ่มคำถามระหว่างบทเรียน</span>
                                            </button>
                                        </div> */}
                                    </div>
                                </div>
