          ...
          <div className="mx-auto space-y-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2 bg-white p-2 ">
                  {profilePic ? (
                    <img
                      src={`http://localhost/trigo/${profilePic}`}
                      alt="Profile"
                  ...
                  <div className="flex flex-col">
                    ...
                    {email && (
                      <p className="text-gray-500 text-xs tracking-wide truncate max-w-xs">{email}</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            {/* <div className="p-2 pt-4 overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
                {recentLessons.slice(0, 4).map((lesson, idx) => (
                  <Link
                    key={idx}
                    to={`/subchapterDetail/${lesson.chapter_id}/${lesson.subchapter_id}`}
                    className="bg-white rounded-2xl p-4 border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all duration-300"
                  >
                    ...
                    <p className="text-[12px] text-gray-500 mb-2">{lesson.chapter_name}</p>
                    ...
                    <div className="mt-3 text-sm text-blue-600 flex items-center group-hover:text-blue-700">
                      แสดงรายการ <ChevronRight size={13} />
                    </div>
                  </Link>
                ))}
                ...
                <Link
                  to="/chapter"
                  className="bg-white rounded-2xl p-4 border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all duration-300 flex flex-col justify-center items-center"
                >
                  <p className="text-sm text-blue-600 flex items-center hover:text-blue-700">
                    แสดงทั้งหมด <ChevronRight size={16} />
                  </p>
                </Link>
              </div>
            </div> */}
