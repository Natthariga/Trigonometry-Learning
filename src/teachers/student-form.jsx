    ...
    const fetchClassrooms = async () => {
      try {
        ...
        if (res.status === "success" && Array.isArray(res.data)) {
          ...
          if (res.data.length > 0) setClassroom(res.data[0].classroom_name); // default
        }
      } catch (err) {
